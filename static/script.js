...
document.addEventListener("DOMContentLoaded", () => {
  ...
  applyForm.addEventListener("submit", async (e) => {
    ...
    if (message.length < 10) { errorEl.textContent = "Message must be at least 10 characters"; return; }
    ...
    if (ok) {
      successEl.textContent = "✓ Application sent! We'll get back to you within 24 hours.";
      applyForm.reset();
    } else {
